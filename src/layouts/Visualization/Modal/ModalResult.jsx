    ...
    >
      ...
      >
        <div className="flex items mb-5">
          ...
          <button onClick={copyPaste} className="ml-auto mr-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded  py-1 px-3">
            Copy
          </button>
          <button
            onClick={closeModal}
            className="bg-red-600 hover:bg-red-700 text-white text-sm rounded  py-1 px-3"
          >
            Close
          </button>
        </div>
